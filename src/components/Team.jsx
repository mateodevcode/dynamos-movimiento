  ...
  return (
    <div className={`w-full flex justify-center items-center dark:bg-gray-900`}>
      <div className={`max-h-max w-10/12 flex flex-col justify-center items-center md:rounded-xl mt-12`}>
        <div className="flex flex-col md:w-10/12 sm:w-10/12">
          <h2 className={`font-sans font-bold md:text-5xl text-center md:mb-10 sm:text-3xl sm:mb-5 dark:text-white`}>
            Team Dynamos
          </h2>
          <p className={`text-center md:text-xl sm:text-base md:mb-10 sm:mb-5 text-gray-600 dark:text-gray-300`}>
...
const CardTeam = () => {
  ...
  return teamDynamo.map((valor, i) => {
    return (
      ...
      >
        <img
          className="flex w-72 rounded-full items-center justify-center mb-6 cursor-pointer"
          src={valor.img}
