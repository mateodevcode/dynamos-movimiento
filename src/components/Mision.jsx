    ...
    <div className=" flex flex-row justify-center items-center lg:mt-12 md:mt-12 sm:mt-12 w-full h-full bg-imagen-aboutus sm:mb-20 ">
      ...
      sm:w-[600px] sm:pb-10 sm:pt-20 sm:mb-20"
       >
        {/* circulo */}
        <div
          className={`flex flex-col rounded-full items-center lg:w-[600px] lg:h-[600px] lg:-mb-20 md:w-[600px] md:h-[600px] md:-mb-20 sm:w-[320px] sm:h-[320px] sm:-mb-64 ${darkMode ? "fondo-estandar-oscuro" : "fondo-estandar-claro"}`}
        ></div>
        {/* texto */}
